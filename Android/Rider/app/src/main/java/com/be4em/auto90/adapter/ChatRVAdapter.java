...
public class ChatRVAdapter extends RecyclerView.Adapter<ChatRVAdapter.ViewHolder> {
    ...
    public ChatRVAdapter(Context context, ArrayList<ChatItem> chatItemArrayList){
        ...
        userID = Integer.parseInt(context.getSharedPreferences("UserDetails", Context.MODE_PRIVATE).getString("userID", "0"));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Log.d("userID", String.valueOf(chatItem.userID) + " - " + String.valueOf(userID));
